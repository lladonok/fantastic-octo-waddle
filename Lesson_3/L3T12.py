...
condition_country = merged['country'].isin(EC_and_R)
condition_quarter = (merged['order_date'].dt.quarter >= 1) & (merged['order_date'].dt.quarter <= 2)
condition_year = merged['order_date'].dt.year == 2023

filtered = merged.loc[
    condition_country & condition_quarter & condition_year,
    ['order_id', 'total']]
